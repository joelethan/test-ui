...
import PaymentCyclesTable from "./PaymentCyclesTable";

function PaymentCyclesView() {
  ...
  return (
    <div>
      <Row className="row-deck pt-2 ps-2 pe-2">
        ...
        <Col md={7}>
          <SelectedCycle key={stateInstitutions} />
        </Col>
      </Row>
    </div>
  );
...
PaymentCyclesView.propTypes = {};

export default PaymentCyclesView;
